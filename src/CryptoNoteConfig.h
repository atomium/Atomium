// Copyright (c) 2017-2018, Bytecoin Coin developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 54; // addresses start with "i"
...
const uint64_t MONEY_SUPPLY									 = UINT64_C(19999999900000000);
...
const uint32_t UPGRADE_HEIGHT_V3                             = 55000;
...
const char     CRYPTONOTE_NAME[]                             = "atomium";
...
const int      P2P_DEFAULT_PORT                              =  36408;
const int      RPC_DEFAULT_PORT                              =  36409;
...
const char     P2P_STAT_TRUSTED_PUB_KEY[] = "a6042b06538a7d3d38d03b01bbd797b70ab4806e39910c099e0c47f75fa2f5f2";
